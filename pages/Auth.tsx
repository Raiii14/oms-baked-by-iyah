    ...
    <div className="min-h-[60vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl border border-stone-100">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          {/* Google Mock */}
          <div>
             <button type="button" onClick={loginWithGoogle} className="w-full flex justify-center py-3 px-4 border border-stone-300 text-sm font-medium rounded-md text-stone-700 bg-white hover:bg-stone-50 transition-colors">
