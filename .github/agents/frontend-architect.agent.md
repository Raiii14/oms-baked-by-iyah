...
argument-hint: Describe the UI component or design system you want to create, or the performance optimization you want to achieve — e.g., "create an accessible button component with keyboard navigation" or "optimize the loading performance of the homepage"
---
