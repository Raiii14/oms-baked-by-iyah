...
argument-hint: Describe the programming concept or code you want explained — e.g., "explain how React's useEffect works with examples" or "break down the quicksort algorithm step by step"
---
